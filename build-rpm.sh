...
fpm -s dir -t rpm -C /tmp/appd --name appd --version ${VER} --iteration ${ITER} --before-install /root/preinstall --url "http://www.appdynamics.com/" --description "Repackaged AppDynamics AppServerAgent & MachineAgent into a single RPM" 
